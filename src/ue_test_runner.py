    ...
    def run_test(self) -> bool:
        ...
        try:
            ...
            with self.results_lock:
                ...
                logger.info(f"  PDU Sessions Established: {self.test_results['pdu_established']}")
        ...
        while time.time() - start_time < timeout_seconds:
            with self.results_lock:
                ...
                if (registered_count == self.number_of_ues and 
                    pdu_established_count == self.number_of_ues):
                    break
            ...
            if current_time - last_update_time >= 2:
                with self.results_lock:
                    logger.info(f"Progress: {self.test_results['registered']}/{self.test_results['total']} registered, "
                              f"{self.test_results['pdu_established']}/{self.test_results['total']} PDU sessions established")
